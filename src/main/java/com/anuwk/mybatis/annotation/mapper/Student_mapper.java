package com.anuwk.mybatis.annotation.mapper;
...
public interface Student_mapper {
   ...
   StudentForAnnotaion getById(int id);

   @Update(update)
   void update(StudentForAnnotaion student);
   ...
   void insert(StudentForAnnotaion student);
}
